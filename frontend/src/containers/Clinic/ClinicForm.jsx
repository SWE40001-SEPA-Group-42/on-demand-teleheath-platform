		...
		<Formik
			...
			validationSchema={Yup.object({
				...
				clAddress: Yup.object({
					...
					line2: Yup.string().matches(/^[ A-Za-z0-9_./#&-]*$/, 'Please enter a valid address'),
					city: Yup.string()
			...
			{formik => (
				<Box px={[4, 4, 20, 40]} h='100vh'>
					...
					<form onSubmit={formik.handleSubmit}>
						<InputField name='clName' type='text' label='Clinic name' placeholder='Clinic name' />
						...
						<InputField name='clUrl' type='text' label='Website' placeholder='Website' />
						...
						<SimpleGrid columns={[1, 2]} spacing={[0, 5]}>
							<InputField name='clAddress.city' type='text' label='City' placeholder='City' />
							<InputField name='clAddress.state' type='text' label='State' placeholder='State' />
						</SimpleGrid>
						<SimpleGrid columns={[1, 2]} spacing={[0, 5]}>
							<InputField
						...
						<Button type='submit' colorScheme='blue' variant='solid' w='100%' my={5}>
							Add clinic
						</Button>
					</form>
				</Box>
